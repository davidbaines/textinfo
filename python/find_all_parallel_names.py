...
def main():
    parser = argparse.ArgumentParser(description="Find names across extracted Bibles. Write to a file.")
    ...
    parser.add_argument("--summary",       type=str,  default="names_summary.csv", help="The filename for the summary csv file.")
    parser.add_argument("--full",          type=str,  default="names_full.csv",  help="The filename for the full csv file.")
    ...
    #parser.add_argument('--output_csv', type=Path, help="The output file for names found.")
    #parser.add_argument('--data_file',  type=Path, help="Specify where to write a data file.")
