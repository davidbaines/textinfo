...
def rename_files(folder, from_ext='.SFM', to_ext='.SFM', from_suffix=None, to_suffix=None, dry_run=True):
    ...
    for file in files:
        ...
        if new_file.is_dir():
            print("Error new_file is a directory not a file: {new_file}")
            exit()
...
def main():
    ...
    parser.add_argument("--from-ext", default='.SFM', help="Current extension of the files to change.")
    parser.add_argument("--to-ext", default='.SFM', help="New extension for the files.")
